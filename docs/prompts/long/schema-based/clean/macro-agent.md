...
TRADE WAR: Check status of the Greenland Crisis. Specifically, evaluate Trump's May 8 threat of "much higher". Identify if we are in a "Panic" or "TACO Reversal" phase.
MARKET TIDE: Analyze VIX, SPY, and QQQ futures.
AI effect
Job reports
