...
export default function RunPage({
  ...
  const handleStop = async (run: Run) => {
    if (
      !window.confirm(
        `Stop run "${run.name ?? "Unnamed"}"? This will cancel all active pipelines.`,
      )
    )
      return;
    try {
          ...
          <Tooltip
            title={
              selectedIds.size === 0
                ...
                : `Delete ${selectedIds.size} selected run${selectedIds.size > 1 ? "s" : ""}`
            }
          >
            <span>
              <IconButton
            ...
            <Table size="small" sx={{ width: "100%" }}>
              <TableHead>
                <TableRow>
                  ...
                  {["Stocks", "Run ID", "Models", "Duration", "Status"].map(
                    (h) => (
                      <TableCell
                        key={h}
                        sx={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <Tooltip
                          title={copiedId === run.id ? "Copied!" : "Copy ID"}
                        >
                          <IconButton
                            size="small"
                            onClick={() => {
                          ...
                          <Tooltip title="Stop run">
                            <Box
                              ...
                              sx={{
                                ...
                                borderRadius: "50%",
                                background:
                                  "radial-gradient(circle at 38% 32%, #ff5c5c 0%, #e00000 55%, #9a0000 100%)",
                                ...
                                boxShadow:
                                  "0 2px 6px rgba(0,0,0,0.6), inset 0 1px 2px rgba(255,255,255,0.25)",
                                ...
                                "&:hover": {
                                  ...
                                  boxShadow:
                                    "0 4px 14px rgba(180,0,0,0.55), inset 0 1px 2px rgba(255,255,255,0.25)",
                                },
      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ color: "text.secondary" }}>
            ...
            <strong style={{ color: "#f44336" }}>{selectedIds.size}</strong> run
            report{selectedIds.size > 1 ? "s" : ""} and all associated output
